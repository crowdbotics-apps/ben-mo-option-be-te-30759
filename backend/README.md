...
## Project Structure
    ...
    ├── ben_mo_option_be_te_30759  # Django project configurations
...
1. Clone this repo and `cd ben_mo_option_be_te_30759`
...
2. Clone this repo and `cd ben_mo_option_be_te_30759`
